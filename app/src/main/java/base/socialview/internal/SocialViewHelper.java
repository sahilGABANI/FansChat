package base.socialview.internal;
...
import base.R;
import base.socialview.widget.SocialView;
...
public final class SocialViewHelper implements SocialView {
                ...
                switch (c) {
                    ...
                    default:
                        if (!Character.isLetterOrDigit(c)) {
                            hashtagEditing = false;
                            mentionEditing = false;
                            if (mentionChangedListener != null) {
                                mentionChangedListener.onMentionChange(false);
                            }
     ...
     * when {@link SocialView.OnClickListener} are activated.
     */
